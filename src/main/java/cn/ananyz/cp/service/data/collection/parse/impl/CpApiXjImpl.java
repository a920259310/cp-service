...
import cn.ananyz.cp.service.data.collection.parse.CpApiXj;
...
@Component
public class CpApiXjImpl extends BaseCpApiImpl implements CpApiXj {
    ...
    private Document getTodayDocument(Date date) throws IOException {
        Document doc = Jsoup.connect("http://www.xjflcp.com/game/sscIndex").get();
        return doc;
    }
    ...
    public static void main(String[] args) throws IOException, ParseException {
        CpApiXjImpl cpApiXj = new CpApiXjImpl();
//        List<CPDataModel> todayAllData = cpApi500.getTodayAllData(new Date());
        System.out.println(cpApiXj.getTodayDocument(new Date()));
    }
    @Override
